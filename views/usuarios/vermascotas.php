                                  ...
                                  <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                <p>¿Realmente deseas eliminar la mascota <?= $row->nombre ?>?</p>
                                          </div>
                                          <div class="modal-footer">
                                          <?= Html::beginForm(Url::toRoute("usuarios/eliminarmascota"), "POST") ?>
